#!~/py-develop/algorithm/graph_homework.py
'''
There are four functions, all about the direct graph
'''
...
def nodes_and_edges(digraph):
    '''
    for the DPA, print the number of nodes and edges of directed
    graph, and the average out-degree.
    '''
    keys = digraph.keys()
    values = digraph.values()
    num_edges = 0
